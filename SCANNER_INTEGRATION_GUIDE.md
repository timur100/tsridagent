...
curl -X POST https://goods-receipt-hub.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/health
```
...
https://goods-receipt-hub.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://goods-receipt-hub.preview.emergentagent.com/portal/admin/id-checks
```

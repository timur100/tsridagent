...
curl -X POST https://europcar-rental.preview.emergentagent.com/api/test/simulate-scan
```
...
https://europcar-rental.preview.emergentagent.com/?folder=/app
...
```
https://europcar-rental.preview.emergentagent.com/portal/admin/id-checks
```

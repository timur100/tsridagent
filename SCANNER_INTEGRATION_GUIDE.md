...
curl -X POST https://tablet-fleet-mgmt.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://tablet-fleet-mgmt.preview.emergentagent.com/api/webhooks/health
```
...
https://tablet-fleet-mgmt.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://tablet-fleet-mgmt.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://tablet-fleet-mgmt.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://tablet-fleet-mgmt.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://agent-hub-77.preview.emergentagent.com/api/test/simulate-scan
```
...
https://agent-hub-77.preview.emergentagent.com/?folder=/app
...
```
https://agent-hub-77.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://offline-agent.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://offline-agent.preview.emergentagent.com/api/webhooks/health
```
...
https://offline-agent.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://offline-agent.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://offline-agent.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://offline-agent.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://kit-workflow-app.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://kit-workflow-app.preview.emergentagent.com/api/webhooks/health
```
...
https://kit-workflow-app.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://kit-workflow-app.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://kit-workflow-app.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://kit-workflow-app.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://agent-control-desk-2.preview.emergentagent.com/api/test/simulate-scan
```
...
https://agent-control-desk-2.preview.emergentagent.com/?folder=/app

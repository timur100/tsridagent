...
curl -X POST https://devops-central-17.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://devops-central-17.preview.emergentagent.com/api/webhooks/health
```
...
https://devops-central-17.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://devops-central-17.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://devops-central-17.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://devops-central-17.preview.emergentagent.com/portal/admin/id-checks
```

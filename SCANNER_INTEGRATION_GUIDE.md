...
curl -X POST https://id-verify-12.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://id-verify-12.preview.emergentagent.com/api/webhooks/health
```
...
https://id-verify-12.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://id-verify-12.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://id-verify-12.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://id-verify-12.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://regula-scanner.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://regula-scanner.preview.emergentagent.com/api/webhooks/health
```
...
https://regula-scanner.preview.emergentagent.com/?folder=/app
...
```
https://regula-scanner.preview.emergentagent.com/portal/admin/id-checks
```

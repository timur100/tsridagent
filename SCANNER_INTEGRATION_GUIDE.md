...
curl -X POST https://single-truth.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://single-truth.preview.emergentagent.com/api/webhooks/health
```
...
https://single-truth.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://single-truth.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://single-truth.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://single-truth.preview.emergentagent.com/portal/admin/id-checks
```

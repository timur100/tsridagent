...
curl -X POST https://tsrid-web-refresh.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/health
```
...
https://tsrid-web-refresh.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://tsrid-web-refresh.preview.emergentagent.com/portal/admin/id-checks
```

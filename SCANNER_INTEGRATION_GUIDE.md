...
curl -X POST https://stability-rescue-1.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://stability-rescue-1.preview.emergentagent.com/api/webhooks/health
```
...
https://stability-rescue-1.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://stability-rescue-1.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://stability-rescue-1.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://stability-rescue-1.preview.emergentagent.com/portal/admin/id-checks
```

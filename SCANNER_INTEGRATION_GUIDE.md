...
curl -X POST https://car-dashboard-13.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://car-dashboard-13.preview.emergentagent.com/api/webhooks/health
```
...
https://car-dashboard-13.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://car-dashboard-13.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://car-dashboard-13.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://car-dashboard-13.preview.emergentagent.com/portal/admin/id-checks
```

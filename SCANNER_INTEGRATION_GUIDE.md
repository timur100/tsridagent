...
curl -X POST https://tablet-agent-1.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://tablet-agent-1.preview.emergentagent.com/api/webhooks/health
```
...
https://tablet-agent-1.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://tablet-agent-1.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://tablet-agent-1.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://tablet-agent-1.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://configsaver.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://configsaver.preview.emergentagent.com/api/webhooks/health
```
...
https://configsaver.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://configsaver.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://configsaver.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://configsaver.preview.emergentagent.com/portal/admin/id-checks
```

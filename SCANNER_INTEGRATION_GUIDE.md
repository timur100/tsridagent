...
curl -X POST https://keyautomat.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://keyautomat.preview.emergentagent.com/api/webhooks/health
```
...
https://keyautomat.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://keyautomat.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://keyautomat.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://keyautomat.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://fleet-genius-9.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://fleet-genius-9.preview.emergentagent.com/api/webhooks/health
```
...
https://fleet-genius-9.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://fleet-genius-9.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://fleet-genius-9.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://fleet-genius-9.preview.emergentagent.com/portal/admin/id-checks
```

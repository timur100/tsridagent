...
curl -X POST https://printer-label-app.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://printer-label-app.preview.emergentagent.com/api/webhooks/health
```
...
https://printer-label-app.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://printer-label-app.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://printer-label-app.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://printer-label-app.preview.emergentagent.com/portal/admin/id-checks
```

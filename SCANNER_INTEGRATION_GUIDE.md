...
curl -X POST https://mongo-atlas-migrate.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/health
```
...
https://mongo-atlas-migrate.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://mongo-atlas-migrate.preview.emergentagent.com/portal/admin/id-checks
```

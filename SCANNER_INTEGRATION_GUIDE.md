...
curl -X POST https://scan-sync-1.preview.emergentagent.com/api/test/simulate-scan
```
...
https://scan-sync-1.preview.emergentagent.com/?folder=/app
...
```
https://scan-sync-1.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://timeflow-portal-1.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/health
```
...
https://timeflow-portal-1.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://timeflow-portal-1.preview.emergentagent.com/portal/admin/id-checks
```

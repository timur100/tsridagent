...
curl -X POST https://windows-heartbeat.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://windows-heartbeat.preview.emergentagent.com/api/webhooks/health
```
...
https://windows-heartbeat.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://windows-heartbeat.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://windows-heartbeat.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://windows-heartbeat.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://desk-manager-2.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://desk-manager-2.preview.emergentagent.com/api/webhooks/health
```
...
https://desk-manager-2.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://desk-manager-2.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://desk-manager-2.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://desk-manager-2.preview.emergentagent.com/portal/admin/id-checks
```

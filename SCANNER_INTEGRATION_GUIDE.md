...
curl -X POST https://inventry-3.preview.emergentagent.com/api/test/simulate-scan
```
...
https://inventry-3.preview.emergentagent.com/?folder=/app
...
```
https://inventry-3.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://asset-manager-hub.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://asset-manager-hub.preview.emergentagent.com/api/webhooks/health
```
...
https://asset-manager-hub.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://asset-manager-hub.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://asset-manager-hub.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://asset-manager-hub.preview.emergentagent.com/portal/admin/id-checks
```

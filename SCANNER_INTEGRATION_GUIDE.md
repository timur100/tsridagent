...
curl -X POST https://hardware-slot-months.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://hardware-slot-months.preview.emergentagent.com/api/webhooks/health
```
...
https://hardware-slot-months.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://hardware-slot-months.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://hardware-slot-months.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://hardware-slot-months.preview.emergentagent.com/portal/admin/id-checks
```

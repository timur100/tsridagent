...
curl -X POST https://datahub-central-4.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://datahub-central-4.preview.emergentagent.com/api/webhooks/health
```
...
https://datahub-central-4.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://datahub-central-4.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://datahub-central-4.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://datahub-central-4.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://sync-mongo.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://sync-mongo.preview.emergentagent.com/api/webhooks/health
```
...
https://sync-mongo.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://sync-mongo.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://sync-mongo.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://sync-mongo.preview.emergentagent.com/portal/admin/id-checks
```

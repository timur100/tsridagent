...
curl -X POST https://scanner-printer-app.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://scanner-printer-app.preview.emergentagent.com/api/webhooks/health
```
...
https://scanner-printer-app.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://scanner-printer-app.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://scanner-printer-app.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://scanner-printer-app.preview.emergentagent.com/portal/admin/id-checks
```

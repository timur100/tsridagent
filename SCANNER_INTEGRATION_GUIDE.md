...
curl -X POST https://enhanced-locations.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://enhanced-locations.preview.emergentagent.com/api/webhooks/health
```
...
https://enhanced-locations.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://enhanced-locations.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://enhanced-locations.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://enhanced-locations.preview.emergentagent.com/portal/admin/id-checks
```

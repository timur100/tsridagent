...
curl -X POST https://bundle-inventory-pro.preview.emergentagent.com/api/test/simulate-scan
```
...
https://bundle-inventory-pro.preview.emergentagent.com/?folder=/app

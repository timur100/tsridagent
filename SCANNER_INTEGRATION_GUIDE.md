...
curl -X POST https://station-config-hub.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://station-config-hub.preview.emergentagent.com/api/webhooks/health
```
...
https://station-config-hub.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://station-config-hub.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://station-config-hub.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://station-config-hub.preview.emergentagent.com/portal/admin/id-checks
```

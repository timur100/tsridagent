...
curl -X POST https://kit-assign.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://kit-assign.preview.emergentagent.com/api/webhooks/health
```
...
https://kit-assign.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://kit-assign.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://kit-assign.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://kit-assign.preview.emergentagent.com/portal/admin/id-checks
```

...
curl -X POST https://bundle-printer-int.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://bundle-printer-int.preview.emergentagent.com/api/webhooks/health
```
...
https://bundle-printer-int.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://bundle-printer-int.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://bundle-printer-int.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://bundle-printer-int.preview.emergentagent.com/portal/admin/id-checks
```

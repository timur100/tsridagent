...
curl -X POST https://tsrid-agent-platform.preview.emergentagent.com/api/test/simulate-scan
```
...
https://tsrid-agent-platform.preview.emergentagent.com/?folder=/app

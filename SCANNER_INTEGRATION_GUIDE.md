...
curl -X POST https://modal-visibility-fix.preview.emergentagent.com/api/test/simulate-scan
```
...
https://modal-visibility-fix.preview.emergentagent.com/?folder=/app

...
curl -X POST https://tsrid-management.preview.emergentagent.com/api/test/simulate-scan
```
...
curl https://tsrid-management.preview.emergentagent.com/api/webhooks/health
```
...
https://tsrid-management.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://tsrid-management.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://tsrid-management.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
```
https://tsrid-management.preview.emergentagent.com/portal/admin/id-checks
```

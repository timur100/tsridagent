...
from routes.verification_proxy import router as verification_proxy_router
...
# Include parking management router
...
# Include Europcar routers (PKW-Vermietungssystem - Alle 3 Phasen)
...
from routes.tenant_hierarchy_list import router as tenant_hierarchy_list_router
from routes.europcar_cross_location import router as europcar_cross_location_router
...
app.include_router(tenant_hierarchy_router, prefix="/api", tags=["tenant-hierarchy"])
app.include_router(tenant_hierarchy_list_router)
app.include_router(europcar_cross_location_router)
...
app.include_router(mobility_router, prefix="/api", tags=["mobility-services"])

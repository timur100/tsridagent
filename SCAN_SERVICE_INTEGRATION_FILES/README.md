...
```bash
curl -X GET https://location-kit-builder.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://location-kit-builder.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/health`

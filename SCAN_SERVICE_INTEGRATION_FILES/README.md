...
```bash
curl -X GET https://auto-booking-16.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://auto-booking-16.preview.emergentagent.com/api/webhooks/health`

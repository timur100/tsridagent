...
```bash
curl -X GET https://mobility-hub-18.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://mobility-hub-18.preview.emergentagent.com/api/webhooks/health`

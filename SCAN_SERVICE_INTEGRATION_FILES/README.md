...
```bash
curl -X GET https://tenant-tracker-28.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tenant-tracker-28.preview.emergentagent.com/api/webhooks/health`

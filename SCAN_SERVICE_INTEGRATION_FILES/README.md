...
```bash
curl -X GET https://wareneingang-flow.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://wareneingang-flow.preview.emergentagent.com/api/webhooks/health`

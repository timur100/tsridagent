...
```bash
curl -X GET https://desk-manager-2.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://desk-manager-2.preview.emergentagent.com/api/webhooks/health`

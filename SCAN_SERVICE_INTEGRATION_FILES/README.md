...
```bash
curl -X GET https://hardware-check.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://hardware-check.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://tsrid-control-panel.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tsrid-control-panel.preview.emergentagent.com/api/webhooks/health`

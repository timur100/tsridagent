...
```bash
curl -X GET https://devops-central-17.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://devops-central-17.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://keyautomat.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://keyautomat.preview.emergentagent.com/api/webhooks/health`

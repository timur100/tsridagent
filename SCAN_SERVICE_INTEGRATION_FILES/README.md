...
```bash
curl -X GET https://tenant-filter-search.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tenant-filter-search.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://agent-control-desk-2.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://agent-control-desk-2.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://asset-id-formatter.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-id-formatter.preview.emergentagent.com/api/webhooks/health`

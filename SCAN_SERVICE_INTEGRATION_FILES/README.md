...
```bash
curl -X GET https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://kit-workflow-app.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://kit-workflow-app.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://admin-portal-dash-1.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://admin-portal-dash-1.preview.emergentagent.com/api/webhooks/health`

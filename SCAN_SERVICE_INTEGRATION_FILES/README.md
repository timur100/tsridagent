...
```bash
curl -X GET https://wareneingang-review.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://wareneingang-review.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://single-truth.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://single-truth.preview.emergentagent.com/api/webhooks/health`

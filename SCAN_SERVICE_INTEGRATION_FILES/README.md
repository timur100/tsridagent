...
```bash
curl -X GET https://car-dashboard-13.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://car-dashboard-13.preview.emergentagent.com/api/webhooks/health`

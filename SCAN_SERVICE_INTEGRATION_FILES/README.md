...
```bash
curl -X GET https://scanner-printer-app.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://scanner-printer-app.preview.emergentagent.com/api/webhooks/health`

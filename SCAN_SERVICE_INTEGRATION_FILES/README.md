...
```bash
curl -X GET https://inventry-3.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://inventry-3.preview.emergentagent.com/api/webhooks/health`

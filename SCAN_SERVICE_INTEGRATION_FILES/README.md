...
```bash
curl -X GET https://fleet-rental-sys.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://fleet-rental-sys.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://asset-intake-live.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-intake-live.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://syncagent.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://syncagent.preview.emergentagent.com/api/webhooks/health`

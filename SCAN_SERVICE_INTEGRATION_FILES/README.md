...
```bash
curl -X GET https://offline-agent.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://offline-agent.preview.emergentagent.com/api/webhooks/health`

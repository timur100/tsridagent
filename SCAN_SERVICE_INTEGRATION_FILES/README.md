...
```bash
curl -X GET https://hardware-slot-months.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://hardware-slot-months.preview.emergentagent.com/api/webhooks/health`

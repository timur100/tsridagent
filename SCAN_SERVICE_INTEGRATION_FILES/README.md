...
```bash
curl -X GET https://station-config-hub.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://station-config-hub.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://modal-visibility-fix.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://modal-visibility-fix.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://tenant-manager-58.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tenant-manager-58.preview.emergentagent.com/api/webhooks/health`

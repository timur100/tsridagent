...
```bash
curl -X GET https://quickmenu-app-2.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://quickmenu-app-2.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://europcar-rental.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://europcar-rental.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://asset-manager-hub.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-manager-hub.preview.emergentagent.com/api/webhooks/health`

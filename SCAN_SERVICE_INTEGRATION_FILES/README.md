...
```bash
curl -X GET https://auto-admin-portal-2.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://auto-admin-portal-2.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://tablet-fleet-sync.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tablet-fleet-sync.preview.emergentagent.com/api/webhooks/health`

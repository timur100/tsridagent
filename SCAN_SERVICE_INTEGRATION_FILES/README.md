...
```bash
curl -X GET https://quicktiles-dash.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://quicktiles-dash.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://sync-mongo.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://sync-mongo.preview.emergentagent.com/api/webhooks/health`

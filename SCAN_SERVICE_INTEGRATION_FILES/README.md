...
```bash
curl -X GET https://asset-sync-app.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-sync-app.preview.emergentagent.com/api/webhooks/health`

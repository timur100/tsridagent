...
```bash
curl -X GET https://electron-regula-hub.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://electron-regula-hub.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://kit-assign.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://kit-assign.preview.emergentagent.com/api/webhooks/health`

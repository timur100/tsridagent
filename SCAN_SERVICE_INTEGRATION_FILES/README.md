...
```bash
curl -X GET https://windows-heartbeat.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://windows-heartbeat.preview.emergentagent.com/api/webhooks/health`

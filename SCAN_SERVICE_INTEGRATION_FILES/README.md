...
```bash
curl -X GET https://configsaver.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://configsaver.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://identity-checks.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://identity-checks.preview.emergentagent.com/api/webhooks/health`

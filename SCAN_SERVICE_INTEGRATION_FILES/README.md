...
```bash
curl -X GET https://label-print-fix-2.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://label-print-fix-2.preview.emergentagent.com/api/webhooks/health`

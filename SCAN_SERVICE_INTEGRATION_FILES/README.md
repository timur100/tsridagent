...
```bash
curl -X GET https://direct-print-ipp.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://direct-print-ipp.preview.emergentagent.com/api/webhooks/health`

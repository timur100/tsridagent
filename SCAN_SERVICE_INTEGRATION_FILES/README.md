...
```bash
curl -X GET https://inventory-check-in.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://inventory-check-in.preview.emergentagent.com/api/webhooks/health`

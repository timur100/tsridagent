...
```bash
curl -X GET https://tsrid-management.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tsrid-management.preview.emergentagent.com/api/webhooks/health`

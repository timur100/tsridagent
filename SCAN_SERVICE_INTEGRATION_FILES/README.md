...
```bash
curl -X GET https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://asset-tracking-7.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-tracking-7.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://datahub-central-4.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://datahub-central-4.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://electron-sync.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://electron-sync.preview.emergentagent.com/api/webhooks/health`

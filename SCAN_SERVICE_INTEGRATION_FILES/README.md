...
```bash
curl -X GET https://stability-rescue-1.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://stability-rescue-1.preview.emergentagent.com/api/webhooks/health`

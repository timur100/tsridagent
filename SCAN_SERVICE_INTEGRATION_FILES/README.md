...
```bash
curl -X GET https://bundle-printer-int.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://bundle-printer-int.preview.emergentagent.com/api/webhooks/health`

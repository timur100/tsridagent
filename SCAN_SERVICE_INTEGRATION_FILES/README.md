...
```bash
curl -X GET https://asset-intake-labels.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-intake-labels.preview.emergentagent.com/api/webhooks/health`

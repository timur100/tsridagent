...
```bash
curl -X GET https://tablet-agent-1.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tablet-agent-1.preview.emergentagent.com/api/webhooks/health`

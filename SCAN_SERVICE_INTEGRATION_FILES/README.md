...
```bash
curl -X GET https://bulk-intake-preview.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://bulk-intake-preview.preview.emergentagent.com/api/webhooks/health`

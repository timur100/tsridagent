...
```bash
curl -X GET https://asset-scanner-sim.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-scanner-sim.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://kiosk-manager-8.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://kiosk-manager-8.preview.emergentagent.com/api/webhooks/health`

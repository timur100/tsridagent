...
```bash
curl -X GET https://fleet-genius-9.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://fleet-genius-9.preview.emergentagent.com/api/webhooks/health`

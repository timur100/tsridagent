...
```bash
curl -X GET https://tenant-security-4.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tenant-security-4.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://asset-kit-builder.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-kit-builder.preview.emergentagent.com/api/webhooks/health`

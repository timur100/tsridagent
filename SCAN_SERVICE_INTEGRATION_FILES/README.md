...
```bash
curl -X GET https://multitenantapp-4.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://multitenantapp-4.preview.emergentagent.com/api/webhooks/health`

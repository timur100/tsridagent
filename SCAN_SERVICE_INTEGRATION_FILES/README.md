...
```bash
curl -X GET https://timetrack-connect.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://timetrack-connect.preview.emergentagent.com/api/webhooks/health`

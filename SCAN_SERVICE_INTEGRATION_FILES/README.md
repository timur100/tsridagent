...
```bash
curl -X GET https://asset-intake-debug.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-intake-debug.preview.emergentagent.com/api/webhooks/health`

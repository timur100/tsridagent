...
```bash
curl -X GET https://agent-hub-77.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://agent-hub-77.preview.emergentagent.com/api/webhooks/health`

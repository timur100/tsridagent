...
```bash
curl -X GET https://printer-label-app.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://printer-label-app.preview.emergentagent.com/api/webhooks/health`

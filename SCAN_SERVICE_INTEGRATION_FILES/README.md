...
```bash
curl -X GET https://kiosk-hardware-hub.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://kiosk-hardware-hub.preview.emergentagent.com/api/webhooks/health`

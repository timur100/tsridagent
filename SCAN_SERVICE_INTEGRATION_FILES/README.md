...
```bash
curl -X GET https://asset-label-print.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-label-print.preview.emergentagent.com/api/webhooks/health`

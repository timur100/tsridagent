...
```bash
curl -X GET https://smart-dashboard-ui.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://smart-dashboard-ui.preview.emergentagent.com/api/webhooks/health`

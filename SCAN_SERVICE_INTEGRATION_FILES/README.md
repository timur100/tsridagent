...
```bash
curl -X GET https://asset-tracker-270.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://asset-tracker-270.preview.emergentagent.com/api/webhooks/health`

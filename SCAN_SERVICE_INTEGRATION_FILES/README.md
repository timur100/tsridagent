...
```bash
curl -X GET https://tablet-mgmt.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tablet-mgmt.preview.emergentagent.com/api/webhooks/health`

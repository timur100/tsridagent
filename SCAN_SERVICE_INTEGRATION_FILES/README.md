...
```bash
curl -X GET https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/health`

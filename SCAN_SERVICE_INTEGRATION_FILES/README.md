...
```bash
curl -X GET https://bundle-inventory-pro.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://bundle-inventory-pro.preview.emergentagent.com/api/webhooks/health`

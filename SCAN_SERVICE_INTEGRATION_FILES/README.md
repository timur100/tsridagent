...
```bash
curl -X GET https://device-portal-4.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://device-portal-4.preview.emergentagent.com/api/webhooks/health`

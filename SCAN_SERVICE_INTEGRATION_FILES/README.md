...
```bash
curl -X GET https://enhanced-locations.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://enhanced-locations.preview.emergentagent.com/api/webhooks/health`

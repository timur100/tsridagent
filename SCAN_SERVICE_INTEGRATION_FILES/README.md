...
```bash
curl -X GET https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/health`

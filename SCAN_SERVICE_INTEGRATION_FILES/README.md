...
```bash
curl -X GET https://tsrid-agent-platform.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tsrid-agent-platform.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://tc78-device-portal.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://tc78-device-portal.preview.emergentagent.com/api/webhooks/health`

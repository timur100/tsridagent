...
```bash
curl -X GET https://intake-restore.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://intake-restore.preview.emergentagent.com/api/webhooks/health`

...
```bash
curl -X GET https://europcar-fleet-app.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://europcar-fleet-app.preview.emergentagent.com/api/webhooks/health`

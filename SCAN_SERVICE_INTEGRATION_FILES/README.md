...
```bash
curl -X GET https://biometric-verify-1.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://biometric-verify-1.preview.emergentagent.com/api/webhooks/health`

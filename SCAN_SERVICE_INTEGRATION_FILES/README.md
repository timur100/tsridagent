...
```bash
curl -X GET https://id-verify-12.preview.emergentagent.com/api/webhooks/health
```
...
3. Testen Sie die Netzwerkverbindung: `curl https://id-verify-12.preview.emergentagent.com/api/webhooks/health`

...
ID_CHECK_WEBHOOK_URL = os.environ.get(
    ...
    'https://device-portal-4.preview.emergentagent.com/api/webhooks/scan-completed'
)
ID_CHECK_IMAGE_UPLOAD_URL = os.environ.get(
    'ID_CHECK_IMAGE_UPLOAD_URL',
    'https://device-portal-4.preview.emergentagent.com/api/webhooks/scan-completed/upload-images'
)

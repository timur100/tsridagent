...
Öffnen Sie: https://station-config-hub.preview.emergentagent.com/?folder=/app
...
3. Health Check: `curl https://station-config-hub.preview.emergentagent.com/api/webhooks/health`

...
Öffnen Sie: https://zebra-asset-scan.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
### Test 1: Health Check
```bash
curl https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/health
```
Erwartete Antwort:
```json
...
3. Health Check: `curl https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/health`

...
Öffnen Sie: https://asset-intake-labels.preview.emergentagent.com/?folder=/app
...
ID_CHECK_WEBHOOK_URL=https://asset-intake-labels.preview.emergentagent.com/api/webhooks/scan-completed
ID_CHECK_IMAGE_UPLOAD_URL=https://asset-intake-labels.preview.emergentagent.com/api/webhooks/scan-completed/upload-images
```
...
### Test 1: Health Check
```bash
curl https://asset-intake-labels.preview.emergentagent.com/api/webhooks/health
```
Erwartete Antwort:
```json
...
3. Health Check: `curl https://asset-intake-labels.preview.emergentagent.com/api/webhooks/health`

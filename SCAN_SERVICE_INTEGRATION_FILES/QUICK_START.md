...
Öffnen Sie: https://printer-label-app.preview.emergentagent.com/?folder=/app
...
3. Health Check: `curl https://printer-label-app.preview.emergentagent.com/api/webhooks/health`

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://agent-control-desk-2.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://agent-control-desk-2.preview.emergentagent.com/portal/admin';
```

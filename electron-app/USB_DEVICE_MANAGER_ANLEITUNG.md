...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tc78-fieldwork-app.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tc78-fieldwork-app.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-tracking-7.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-tracking-7.preview.emergentagent.com/portal/admin';
```

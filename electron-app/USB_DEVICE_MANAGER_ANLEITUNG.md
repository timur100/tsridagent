...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://location-kit-builder.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://location-kit-builder.preview.emergentagent.com/portal/admin';
```

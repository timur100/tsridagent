...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tenant-filter-search.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tenant-filter-search.preview.emergentagent.com/portal/admin';
```

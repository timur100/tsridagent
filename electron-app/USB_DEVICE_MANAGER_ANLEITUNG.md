...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tsrid-control-panel.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tsrid-control-panel.preview.emergentagent.com/portal/admin';
```

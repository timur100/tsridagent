...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-intake-labels.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-intake-labels.preview.emergentagent.com/portal/admin';
```

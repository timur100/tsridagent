...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://windows-heartbeat.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://windows-heartbeat.preview.emergentagent.com/portal/admin';
```

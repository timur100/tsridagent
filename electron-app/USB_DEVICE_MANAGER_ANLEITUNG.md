...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tsrid-management.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tsrid-management.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-intake-debug.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-intake-debug.preview.emergentagent.com/portal/admin';
```

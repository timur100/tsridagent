...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tenant-security-4.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tenant-security-4.preview.emergentagent.com/portal/admin';
```

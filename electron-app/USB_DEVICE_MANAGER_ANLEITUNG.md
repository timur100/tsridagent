...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://bulk-intake-preview.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://bulk-intake-preview.preview.emergentagent.com/portal/admin';
```

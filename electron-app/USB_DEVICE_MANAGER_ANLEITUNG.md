...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://enhanced-locations.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://enhanced-locations.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://device-portal-4.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://device-portal-4.preview.emergentagent.com/portal/admin';
```

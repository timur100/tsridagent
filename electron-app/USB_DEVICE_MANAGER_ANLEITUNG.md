...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-label-print.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-label-print.preview.emergentagent.com/portal/admin';
```

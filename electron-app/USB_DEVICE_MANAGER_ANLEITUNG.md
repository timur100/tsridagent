...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://zebra-asset-scan.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://zebra-asset-scan.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://station-config-hub.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://station-config-hub.preview.emergentagent.com/portal/admin';
```

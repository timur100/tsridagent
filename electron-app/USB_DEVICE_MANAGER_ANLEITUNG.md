...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://label-print-fix-2.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://label-print-fix-2.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://devops-central-17.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://devops-central-17.preview.emergentagent.com/portal/admin';
```

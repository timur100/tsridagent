...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tablet-fleet-mgmt.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tablet-fleet-mgmt.preview.emergentagent.com/portal/admin';
```

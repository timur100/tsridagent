...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://modal-visibility-fix.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://modal-visibility-fix.preview.emergentagent.com/portal/admin';
```

...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://kit-workflow-app.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://kit-workflow-app.preview.emergentagent.com/portal/admin';
```

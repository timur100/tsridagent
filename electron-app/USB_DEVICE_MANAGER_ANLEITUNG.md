...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://bundle-printer-int.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://bundle-printer-int.preview.emergentagent.com/portal/admin';
```

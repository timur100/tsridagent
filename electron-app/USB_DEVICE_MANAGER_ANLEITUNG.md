...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://multitenantapp-4.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://multitenantapp-4.preview.emergentagent.com/portal/admin';
```

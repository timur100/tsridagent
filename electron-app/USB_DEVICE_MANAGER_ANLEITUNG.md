...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://bundle-inventory-pro.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://bundle-inventory-pro.preview.emergentagent.com/portal/admin';
```

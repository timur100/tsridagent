...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://goods-receipt-hub.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://goods-receipt-hub.preview.emergentagent.com/portal/admin';
```

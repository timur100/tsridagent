...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://printer-label-app.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://printer-label-app.preview.emergentagent.com/portal/admin';
```

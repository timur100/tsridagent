...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://wareneingang-flow.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://wareneingang-flow.preview.emergentagent.com/portal/admin';
```

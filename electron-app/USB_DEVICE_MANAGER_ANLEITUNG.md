...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://tsrid-web-refresh.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://tsrid-web-refresh.preview.emergentagent.com/portal/admin';
```

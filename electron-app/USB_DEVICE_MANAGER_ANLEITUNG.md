...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-kit-builder.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-kit-builder.preview.emergentagent.com/portal/admin';
```

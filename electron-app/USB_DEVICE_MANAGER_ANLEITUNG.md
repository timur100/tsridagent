...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://electron-regula-hub.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://electron-regula-hub.preview.emergentagent.com/portal/admin';
```

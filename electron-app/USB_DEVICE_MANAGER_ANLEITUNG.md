...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://inventory-check-in.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://inventory-check-in.preview.emergentagent.com/portal/admin';
```

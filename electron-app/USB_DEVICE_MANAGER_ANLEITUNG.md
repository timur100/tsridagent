...
1. **Automatischer Login-Screen:**
   - Die App lädt: `https://asset-intake-live.preview.emergentagent.com/portal/admin`
...
Standard ist:
```javascript
const PREVIEW_URL = 'https://asset-intake-live.preview.emergentagent.com/portal/admin';
```

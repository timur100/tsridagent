...
user_problem_statement: "SubTabNavigation Component Testing for 3 New R&D Sections: Test the newly implemented tab navigation for 3 R&D sections: Zeiterfassung, Steuerung, and Surveillance. Verify SubTabNavigation component for: 1) Zeiterfassung (tabs: Übersicht, Terminal, Berichte, Einstellungen), 2) Steuerung (tabs: Übersicht, Geräte, Automatisierung, Einstellungen), 3) Surveillance (tabs: Übersicht, Kameras, Monitoring, Alarme). Login with admin@tsrid.com/admin123, navigate to R&D section, locate each section in sidebar (Zeiterfassung under Zutrittskontrolle, Steuerung under Steuerung, Surveillance under Surveillance), verify SubTabNavigation displays with correct tabs, verify tab functionality and active tab highlighting in red (#c00000)."

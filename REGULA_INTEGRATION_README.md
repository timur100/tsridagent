...
```bash
curl -X POST https://windows-heartbeat.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://windows-heartbeat.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

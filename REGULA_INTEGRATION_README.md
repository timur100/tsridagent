...
```bash
curl -X POST https://wareneingang-flow.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://wareneingang-flow.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://station-config-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://station-config-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

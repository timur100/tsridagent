...
```bash
curl -X POST https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://goods-receipt-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

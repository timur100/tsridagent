...
```bash
curl -X POST https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://zebra-asset-scan.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://scanner-printer-app.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://scanner-printer-app.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

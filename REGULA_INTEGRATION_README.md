...
```bash
curl -X POST https://single-truth.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://single-truth.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://mongo-atlas-migrate.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://quickmenu-app-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://quickmenu-app-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

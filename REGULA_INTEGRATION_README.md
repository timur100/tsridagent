...
```bash
curl -X POST https://asset-intake-debug.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-intake-debug.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

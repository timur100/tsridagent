...
```bash
curl -X POST https://mobility-hub-18.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://mobility-hub-18.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

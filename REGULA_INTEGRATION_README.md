...
```bash
curl -X POST https://intake-restore.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://intake-restore.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

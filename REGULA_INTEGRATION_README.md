...
```bash
curl -X POST https://tenant-security-4.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tenant-security-4.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

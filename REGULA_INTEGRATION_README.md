...
```bash
curl -X POST https://biometric-verify-1.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://biometric-verify-1.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

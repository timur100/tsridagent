...
```bash
curl -X POST https://asset-sync-app.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-sync-app.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

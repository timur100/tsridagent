...
```bash
curl -X POST https://modal-visibility-fix.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://modal-visibility-fix.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

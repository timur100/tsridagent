...
```bash
curl -X POST https://kiosk-hardware-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://kiosk-hardware-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

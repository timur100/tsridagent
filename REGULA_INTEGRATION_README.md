...
```bash
curl -X POST https://auto-admin-portal-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://auto-admin-portal-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://datahub-central-4.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://datahub-central-4.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

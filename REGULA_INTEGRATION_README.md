...
```bash
curl -X POST https://bulk-intake-preview.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://bulk-intake-preview.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

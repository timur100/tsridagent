...
```bash
curl -X POST https://tenant-filter-search.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tenant-filter-search.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://hardware-slot-months.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://hardware-slot-months.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

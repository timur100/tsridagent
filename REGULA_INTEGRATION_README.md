...
```bash
curl -X POST https://tenant-tracker-28.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tenant-tracker-28.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

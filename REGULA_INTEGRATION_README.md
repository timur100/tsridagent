...
```bash
curl -X POST https://inventory-check-in.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://inventory-check-in.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://tsrid-management.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tsrid-management.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

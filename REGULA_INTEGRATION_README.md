...
```bash
curl -X POST https://asset-tracker-270.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-tracker-270.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

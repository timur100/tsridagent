...
```bash
curl -X POST https://bundle-inventory-pro.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://bundle-inventory-pro.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

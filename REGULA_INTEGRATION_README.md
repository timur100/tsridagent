...
```bash
curl -X POST https://fleet-rental-sys.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://fleet-rental-sys.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

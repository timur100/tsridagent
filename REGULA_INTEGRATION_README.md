...
```bash
curl -X POST https://fleet-genius-9.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://fleet-genius-9.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://asset-id-formatter.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-id-formatter.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://desk-manager-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://desk-manager-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://quicktiles-dash.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://quicktiles-dash.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

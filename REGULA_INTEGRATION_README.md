...
```bash
curl -X POST https://stability-rescue-1.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://stability-rescue-1.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

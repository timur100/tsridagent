...
```bash
curl -X POST https://asset-manager-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-manager-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

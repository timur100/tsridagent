...
```bash
curl -X POST https://label-print-fix-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://label-print-fix-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

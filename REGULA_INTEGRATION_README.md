...
```bash
curl -X POST https://wareneingang-review.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://wareneingang-review.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

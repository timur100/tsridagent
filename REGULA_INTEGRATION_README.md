...
```bash
curl -X POST https://smart-dashboard-ui.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://smart-dashboard-ui.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://bundle-printer-int.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://bundle-printer-int.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

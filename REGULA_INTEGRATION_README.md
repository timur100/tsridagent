...
```bash
curl -X POST https://europcar-rental.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://europcar-rental.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://tc78-device-portal.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tc78-device-portal.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://asset-manager-pro-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-manager-pro-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

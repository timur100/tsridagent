...
```bash
curl -X POST https://tablet-agent-1.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tablet-agent-1.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

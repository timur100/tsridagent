...
```bash
curl -X POST https://tsrid-agent-platform.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tsrid-agent-platform.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

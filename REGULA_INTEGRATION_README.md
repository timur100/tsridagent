...
```bash
curl -X POST https://location-kit-builder.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://location-kit-builder.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

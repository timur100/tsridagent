...
```bash
curl -X POST https://tablet-fleet-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tablet-fleet-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

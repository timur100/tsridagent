...
```bash
curl -X POST https://auto-booking-16.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://auto-booking-16.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

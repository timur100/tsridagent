...
```bash
curl -X POST https://electron-regula-hub.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://electron-regula-hub.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

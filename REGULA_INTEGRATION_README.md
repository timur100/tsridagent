...
```bash
curl -X POST https://regula-scanner.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://regula-scanner.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

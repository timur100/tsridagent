...
```bash
curl -X POST https://asset-intake-live.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-intake-live.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

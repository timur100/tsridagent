...
```bash
curl -X POST https://asset-tracking-7.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-tracking-7.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

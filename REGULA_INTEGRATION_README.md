...
```bash
curl -X POST https://europcar-fleet-app.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://europcar-fleet-app.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

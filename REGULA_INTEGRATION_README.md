...
```bash
curl -X POST https://agent-hub-77.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://agent-hub-77.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

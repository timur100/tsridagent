...
```bash
curl -X POST https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://timeflow-portal-1.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

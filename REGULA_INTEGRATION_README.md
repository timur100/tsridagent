...
```bash
curl -X POST https://agent-control-desk-2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://agent-control-desk-2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

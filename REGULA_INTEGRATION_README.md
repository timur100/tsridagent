...
```bash
curl -X POST https://asset-label-print.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-label-print.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

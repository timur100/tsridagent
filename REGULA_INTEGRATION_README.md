...
```bash
curl -X POST https://enhanced-locations.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://enhanced-locations.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

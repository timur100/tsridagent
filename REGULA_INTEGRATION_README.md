...
```bash
curl -X POST https://device-portal-4.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://device-portal-4.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

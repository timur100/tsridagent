...
```bash
curl -X POST https://devops-central-17.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://devops-central-17.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

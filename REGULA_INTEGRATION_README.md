...
```bash
curl -X POST https://timetrack-connect.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://timetrack-connect.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://tsrid-control-panel.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tsrid-control-panel.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

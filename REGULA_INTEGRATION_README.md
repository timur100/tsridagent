...
```bash
curl -X POST https://hardware-check.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://hardware-check.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

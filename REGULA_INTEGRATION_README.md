...
```bash
curl -X POST https://kit-workflow-app.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://kit-workflow-app.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

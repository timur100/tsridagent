...
```bash
curl -X POST https://asset-kit-builder.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-kit-builder.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://tsrid-web-refresh.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

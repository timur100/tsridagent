...
```bash
curl -X POST https://direct-print-ipp.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://direct-print-ipp.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

...
```bash
curl -X POST https://kiosk-manager-8.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://kiosk-manager-8.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

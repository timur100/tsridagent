...
```bash
curl -X POST https://asset-scanner-sim.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-scanner-sim.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

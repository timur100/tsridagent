...
```bash
curl -X POST https://asset-mgmt-v2.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://asset-mgmt-v2.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

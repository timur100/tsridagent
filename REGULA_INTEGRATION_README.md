...
```bash
curl -X POST https://printer-label-app.preview.emergentagent.com/api/webhooks/regula-scan \
...
response = requests.post(
    "https://printer-label-app.preview.emergentagent.com/api/webhooks/regula-scan",
    json=scan_data,

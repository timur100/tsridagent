        ...
        {activeTab === 'key-automat' && (
          <Card className={`p-8 rounded-xl ${
            ...
            <div className="space-y-6">
              <div>
                <h3 className={`text-xl font-semibold mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                  🔐 Schlüsselautomat-Verwaltung
                </h3>
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                  Verwalten Sie Schlüsselautomaten, Standorte und Schlüssel für {tenant?.display_name || 'diesen Tenant'}.
                </p>
              </div>
              ...
              <div className={`p-6 rounded-lg border-2 border-dashed text-center ${
                ...
                <p className={`text-sm font-medium mb-1 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                  Schlüsselautomat-Management
                </p>
                <p className={`text-xs ${theme === 'dark' ? 'text-gray-500' : 'text-gray-500'}`}>
                  Vollständige Verwaltung von Standorten, Automaten und Schlüsseln für diesen Tenant.
                  <br />Nutzen Sie die Quick Actions, um schnell mit der Konfiguration zu beginnen.
                </p>
              </div>
            </div>
          </Card>

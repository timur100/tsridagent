...
const RnDSidebar = ({ activeSection, onSectionChange, collapsed, onToggleCollapse }) => {
  ...
  const [expandedCategories, setExpandedCategories] = useState(['mobile-dev', 'biometrics', 'vehicles', 'parking', 'access', 'ai', 'imaging', 'kiosk', 'automation', 'control', 'surveillance', 'services', 'shipping', 'telephony', 'test-center']);

...
const RnDSidebar = ({ activeSection, onSectionChange, collapsed, onToggleCollapse }) => {
  ...
  const [expandedCategories, setExpandedCategories] = useState(['biometrics', 'vehicles', 'parking', 'access', 'ai', 'imaging', 'kiosk', 'automation', 'control', 'surveillance', 'services', 'shipping', 'telephony']);

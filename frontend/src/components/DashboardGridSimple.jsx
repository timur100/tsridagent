...
const DashboardGridSimple = ({ children }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-1" style={{ gridAutoRows: '160px', overflow: 'visible' }}>
        {(() => {
          const allItems = [];
          let cardIdx = 0;
          const totalItems = cardOrder.length + dummyCards.length;
      ...
      {/* Custom CSS for fixed equal height cards */}
      <style>{`
        /* All grid items have fixed height of 160px */
        .grid > div {
          height: 160px;
          display: flex;
        ...
        /* Card content fills and scrolls if needed */
        .grid > div > div {
          flex: 1;
          display: flex;
          flex-direction: column;
        ...
        /* Ensure Card components fit within the fixed height */
        .grid > div > div > * {
          height: 100%;

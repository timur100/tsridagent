...
import ConnectionStatusIndicators from './ConnectionStatusIndicators';
...
const VerificationInterface = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      {/* Connection Status Indicators - OBEN RECHTS */}
      ...
      {/* Simulationsmodus Badge - UNTER DEN STATUS INDIKATOREN */}

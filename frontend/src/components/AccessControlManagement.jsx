    ...
    <div className="w-full">
      <SubTabNavigation
        tabs={[
          ...
          { id: 'doors', label: 'Türen', icon: Users },
          { id: 'logs', label: 'Protokoll', icon: Clock },
      ...
      <div>
        <div className="mb-6">
          ...
          <p className={`mt-2 text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
            Elektronische Zutrittskontrolle und Verwaltung
          </p>
        </div>

        <div className="text-center py-12">
          <Shield className={`h-16 w-16 mx-auto mb-4 ${theme === 'dark' ? 'text-gray-600' : 'text-gray-400'}`} />

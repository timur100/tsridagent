...
```bash
curl "https://tablet-fleet-mgmt.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://tablet-fleet-mgmt.preview.emergentagent.com/api/dhl/shipments/mock"
```
...
```bash
curl -X POST "https://tablet-fleet-mgmt.preview.emergentagent.com/api/dhl/shipments" \

...
```bash
curl "https://hardware-slot-months.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://hardware-slot-months.preview.emergentagent.com/api/dhl/shipments/mock"
```

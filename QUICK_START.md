...
```bash
curl "https://station-config-hub.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://station-config-hub.preview.emergentagent.com/api/dhl/shipments/mock"
```
...
```bash
curl -X POST "https://station-config-hub.preview.emergentagent.com/api/dhl/shipments" \

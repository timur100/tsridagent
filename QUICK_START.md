...
```bash
curl "https://electron-regula-hub.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://electron-regula-hub.preview.emergentagent.com/api/dhl/shipments/mock"
```

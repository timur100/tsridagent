...
```bash
curl "https://location-kit-builder.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://location-kit-builder.preview.emergentagent.com/api/dhl/shipments/mock"
```

...
```bash
curl "https://scanner-printer-app.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://scanner-printer-app.preview.emergentagent.com/api/dhl/shipments/mock"
```

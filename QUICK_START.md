...
```bash
curl "https://tsrid-agent-platform.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://tsrid-agent-platform.preview.emergentagent.com/api/dhl/shipments/mock"
```

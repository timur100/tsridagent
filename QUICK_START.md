...
```bash
curl "https://bulk-intake-preview.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://bulk-intake-preview.preview.emergentagent.com/api/dhl/shipments/mock"
```

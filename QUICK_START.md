...
```bash
curl "https://tsrid-control-panel.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://tsrid-control-panel.preview.emergentagent.com/api/dhl/shipments/mock"
```

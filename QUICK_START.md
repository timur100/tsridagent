...
```bash
curl "https://asset-intake-labels.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://asset-intake-labels.preview.emergentagent.com/api/dhl/shipments/mock"
```

...
```bash
curl "https://agent-control-desk-2.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://agent-control-desk-2.preview.emergentagent.com/api/dhl/shipments/mock"
```

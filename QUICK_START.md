...
```bash
curl "https://wareneingang-review.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://wareneingang-review.preview.emergentagent.com/api/dhl/shipments/mock"
```

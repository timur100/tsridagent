...
```bash
curl "https://bundle-inventory-pro.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://bundle-inventory-pro.preview.emergentagent.com/api/dhl/shipments/mock"
```

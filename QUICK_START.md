...
```bash
curl "https://asset-manager-pro-2.preview.emergentagent.com/api/dhl/health"
```
...
```bash
curl "https://asset-manager-pro-2.preview.emergentagent.com/api/dhl/shipments/mock"
```

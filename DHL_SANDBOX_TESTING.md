...
#### 1. Health Check
```bash
curl -s "https://fleet-rental-sys.preview.emergentagent.com/api/dhl/health" | jq
```
...
```bash
curl -s "https://fleet-rental-sys.preview.emergentagent.com/api/dhl/shipments/mock" | jq
```

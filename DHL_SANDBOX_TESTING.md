...
```bash
curl -s "https://quickmenu-app-2.preview.emergentagent.com/api/dhl/shipments/mock" | jq
```

#### 3. Test-Sendung erstellen (Sandbox)
```bash
curl -X POST "https://quickmenu-app-2.preview.emergentagent.com/api/dhl/shipments" \
